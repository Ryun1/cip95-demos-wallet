  ...
  return (() => {
    var t = {
        ...
        './node_modules/es6-promise/dist/es6-promise.js': function (t, e, r) {
           ...
           */ t.exports = (function () {
            ...
            function q(t, e) {
              t._state === S && ((t._state = P), (t._result = e), u(N, t));
            }
            function G(t, e, r, n) {
    ...
    return (
      (() => {
        ...
        var o = r('./node_modules/@babel/runtime/regenerator/index.js'),
          i = r.n(o),
          s = r('./node_modules/cross-fetch/dist/browser-ponyfill.js'),
          a = r.n(s),
          u = (function () {
            var t = n(
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        ...
                        return t.abrupt('return');
                      case 6:
                        return (t.next = 8), u('./data/config.json', 'json');
                      case 8:
                        (s = t.sent),
                          (a = s.webusb.map(function (t) {
                            return {
