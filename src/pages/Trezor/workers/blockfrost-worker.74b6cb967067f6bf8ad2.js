(() => {
  var e = {
      ...
      './node_modules/@trezor/blockchain-link/lib/workers/blockfrost/utils.js':
        (e, t, n) => {
          'use strict';
          Object.defineProperty(t, '__esModule', { value: !0 }),
          ...
          t.transformUtxos = (e) => {
            ...
            return (
              e.forEach((e) =>
                e.utxoData.amount.forEach((n) => {
                  t.push({
                    address: e.address,
                    txid: e.utxoData.tx_hash,
                    confirmations: e.blockInfo.confirmations,
                    blockHeight: e.blockInfo.height || 0,
                    amount: n.quantity,
                    vout: e.utxoData.output_index,
                    path: e.path,
                    cardanoSpecific: { unit: n.unit },
                  });
                })
              ),
              t
          ...
          t.getSubtype = (e) => {
            if (e.txData.withdrawal_count > 0) return 'withdrawal';
            const t = e.txData.stake_cert_count,
              n = e.txData.delegation_count;
            return 0 === t && 0 === n
              ? null
              : t > 0
              ? new r.default(e.txData.deposit).gt(0)
                ? 'stake_registration'
          ...
          t.transformTokenInfo = (e) => {
            ...
            const n = e.map((e) => {
              const { assetName: n } = (0, t.parseAsset)(e.unit);
              return {
                type: 'BLOCKFROST',
                name: e.fingerprint,
                address: e.unit,
                symbol: n || e.fingerprint,
                balance: e.quantity,
                decimals: e.decimals,
              };
            });
          ...
          t.transformInputOutput = (e, t = 'lovelace') =>
            e.map((e) => {
              var n, r;
              return {
                n: e.output_index,
                ...
                value:
                  null !==
                    (r =
                      null === (n = e.amount.find((e) => e.unit === t)) ||
                      void 0 === n
                        ? void 0
                        : n.quantity) && void 0 !== r
                    ? r
          ...
          t.filterTokenTransfers = (e, n, r) => {
            const i = [],
              o = e.used.concat(e.unused),
              c = e.change.concat(o);
            return (
              n.txUtxos.outputs.forEach((a) => {
                a.amount
                  .filter((e) => 'lovelace' !== e.unit)
                  .forEach((u) => {
                    var l;
                    const f = u.unit,
                      d = (0, t.transformInputOutput)(n.txUtxos.inputs, f),
                      h = (0, t.transformInputOutput)(n.txUtxos.outputs, f),
                      p = (0, s.filterTargets)(c, d),
                      m = (0, s.filterTargets)(c, h),
                      _ = e.change.find((e) => e.address === a.address);
                    if (0 === m.length && 0 === p.length) return null;
                    const g = (0, s.filterTargets)(
                      o,
                      (0, t.transformInputOutput)([a], f)
                    );
                    let v = '0';
                    if (
                      ('sent' === r
                        ? (v = _ ? '0' : u.quantity)
                        : 'recv' === r
                        ? (v = (0, s.sumVinVout)(g, '0'))
                        : 'self' !== r || _ || (v = (0, s.sumVinVout)(g, '0')),
                      '0' === v || !u.fingerprint)
                    )
                      return null;
                    const { assetName: b } = (0, t.parseAsset)(f);
                    i.push({
                      type: r,
                      name: u.fingerprint,
                      symbol: b || u.fingerprint,
                      address: u.unit,
                      decimals: u.decimals,
                      amount: v.toString(),
                      from:
                        'sent' === r || 'self' === r
                          ? n.address
                          : null ===
                              (l = n.txUtxos.inputs.find((e) =>
                                e.amount.find((e) => e.unit === f)
                              )) || void 0 === l
                          ? void 0
                          : l.address,
                      to: 'recv' === r ? n.address : a.address,
                    });
                  });
              }),
              i.filter((e) => !!e)
          ...
          t.transformTransaction = (e, n, i) => {
            var o;
            const c = n ? n.change.concat(n.used, n.unused) : [e];
            let a,
              u = [],
              l =
                (null ===
                  (o = i.txData.output_amount.find(
                    (e) => 'lovelace' === e.unit
                  )) || void 0 === o
                  ? void 0
                  : o.quantity) || '0';
            const f = i.txData.fees;
            let d,
              h,
              p = l;
            const m = (0, t.transformInputOutput)(i.txUtxos.inputs),
              _ = (0, t.transformInputOutput)(i.txUtxos.outputs),
              g = Array.isArray(m) ? m.length : 0,
              v = Array.isArray(_) ? _.length : 0,
              b = (0, s.filterTargets)(c, m),
              E = (0, s.filterTargets)(c, _),
              y = n ? (0, s.filterTargets)(n.change, _) : [],
              T = (0, s.sumVinVout)(g ? m : []),
              S = (0, s.sumVinVout)(v ? _ : []);
            if (0 === b.length && 0 === E.length) a = 'unknown';
            else if (g > 0 && v > 0 && b.length === g && E.length === v)
              (a = 'self'),
                (u = _.filter((e) => y.indexOf(e) < 0)),
                (l = i.txData.fees),
                (p = l),
                i.txData.withdrawal_count > 0 &&
                  (d = new r.default(S)
                    .plus(i.txData.fees)
                    .minus(T)
                    .toString()),
                new r.default(i.txData.deposit).gt(0) && (h = i.txData.deposit);
            else if (0 === b.length && E.length > 0)
              (a = 'recv'),
                (l = '0'),
                E.length > 0 &&
                  ((u = E), (l = (0, s.sumVinVout)(E, l)), (p = l));
            else if (
              ((a = 'sent'), (u = _.filter((e) => y.indexOf(e) < 0)), v)
            ) {
              const e = (0, s.sumVinVout)(b, '0');
              (p = (0, s.sumVinVout)(E, e, 'reduce')),
                (l = new r.default(p).minus(null != f ? f : '0').toString());
            }
            const w = n ? (0, t.filterTokenTransfers)(n, i, a) : [];
            return {
              type: a,
              txid: i.txHash,
              blockTime: i.txData.block_time,
              blockHeight: i.txData.block_height || void 0,
              blockHash: i.txData.block,
              amount: l,
              fee: f,
              totalSpent: p,
              targets: u.map((e) => (0, s.transformTarget)(e, E)),
              tokens: w,
              cardanoSpecific: {
                subtype: (0, t.getSubtype)(i),
                withdrawal: d,
                deposit: h,
              },
              details: {
                ...
                vout: _,
                size: i.txData.size,
                totalInput: T ? T.toString() : '0',
                totalOutput: S ? S.toString() : '0',
              },
            };
          };
          t.transformAccountInfo = (e) => {
            const n = e.history.transactions;
            return Object.assign(Object.assign({}, e), {
              tokens: (0, t.transformTokenInfo)(e.tokens),
              history: Object.assign(Object.assign({}, e.history), {
                transactions: n
                  ? null == n
                    ? void 0
                    : n.map((n) =>
                        (0, t.transformTransaction)(
                          e.descriptor,
                          e.addresses,
                          n
                        )
      ...
      './node_modules/@trezor/blockchain-link/lib/workers/blockfrost/websocket.js':
        (e, t, n) => {
          'use strict';
          Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.BlockfrostAPI = void 0);
          ...
          class a extends s.EventEmitter {
            ...
            connect() {
              ...
              const t = (0, i.createDeferred)(-1),
                n = new r(e, { agent: this.options.agent });
              return (
            ...
            getBlockHash(e) {
              return this.send('GET_BLOCK', { hashOrNumber: e });
            }
            estimateFee(e) {
              return this.send('ESTIMATE_FEE', e);
            }
            getAccountInfo(e) {
              return this.send('GET_ACCOUNT_INFO', e);
            }
            getAccountUtxo(e) {
              return this.send('GET_ACCOUNT_UTXO', { descriptor: e });
            }
            getAccountBalanceHistory(e) {
              return this.send('GET_BALANCE_HISTORY', e);
            }
            getTransaction(e) {
              return this.send('GET_TRANSACTION', { txId: e });
            }
            pushTransaction(e) {
              return this.send('PUSH_TRANSACTION', { txData: e });
            }
            subscribeBlock() {
            ...
            subscribeAddresses(e) {
              ...
              return (
                ...
                this.send('SUBSCRIBE_ADDRESS', { addresses: e })
              );
            }
            unsubscribeBlock() {
              const e = this.subscriptions.findIndex((e) => 'block' === e.type);
          ...
          (i = (function e(t) {
            ...
            function K(e, t) {
              var n,
                ...
                _,
                g = this;
              if (!(g instanceof K)) return new K(e, t);
              if (null == t) {
                ...
                if ((p = 'number' == typeof e) && 0 * e == 0) {
                  ...
                  if (!o.test((_ = String(e)))) return s(g, _, p);
                  g.s = 45 == _.charCodeAt(0) ? ((_ = _.slice(1)), -1) : 1;
                }
                (u = _.indexOf('.')) > -1 && (_ = _.replace('.', '')),
                  (f = _.search(/e/i)) > 0
                    ? (u < 0 && (u = f),
                      (u += +_.slice(f + 1)),
                      (_ = _.substring(0, f)))
                ...
                if ((E(t, 2, H.length, 'Base'), 10 == t && z))
                  return $((g = new K(e)), x + g.e + 1, L);
                if (((_ = String(e)), (p = 'number' == typeof e))) {
                  if (0 * e != 0) return s(g, _, p, t);
                  if (
                    ((g.s = 1 / e < 0 ? ((_ = _.slice(1)), -1) : 1),
                    K.DEBUG && _.replace(/^0\.0*|\./, '').length > 15)
                  )
                    throw Error(l + e);
                } else
                  g.s = 45 === _.charCodeAt(0) ? ((_ = _.slice(1)), -1) : 1;
                for (n = H.slice(0, t), u = f = 0, m = _.length; f < m; f++)
                  if (n.indexOf((i = _.charAt(f))) < 0) {
                    if ('.' == i) {
                      if (f > u) {
                        u = m;
                        continue;
                ...
                (p = !1),
                  (u = (_ = r(_, t, 10, g.s)).indexOf('.')) > -1
                    ? (_ = _.replace('.', ''))
                    : (u = _.length);
              }
              for (f = 0; 48 === _.charCodeAt(f); f++);
              for (m = _.length; 48 === _.charCodeAt(--m); );
              if ((_ = _.slice(f, ++m))) {
                if (((m -= f), p && K.DEBUG && m > 15 && (e > h || e !== a(e))))
                  throw Error(l + g.s * e);
                if ((u = u - f - 1) > B) g.c = g.e = null;
                else if (u < P) g.c = [(g.e = 0)];
                else {
                  if (
                    ((g.e = u),
                    (g.c = []),
                    ...
                    for (f && g.c.push(+_.slice(0, f)), m -= d; f < m; )
                      g.c.push(+_.slice(f, (f += d)));
                    f = d - (_ = _.slice(f)).length;
                  } else f -= m;
                  for (; f--; _ += '0');
                  g.c.push(+_);
                }
            ...
            function V(e, t, n, r) {
              var s, i, o, c, a;
              if ((null == n ? (n = L) : E(n, 0, 8), !e.c)) return e.toString();
            ...
            function W(e, t) {
              for (var n, r = 1, s = new K(e[0]); r < e.length; r++) {
                if (!(n = new K(e[r])).s) {
                  s = n;
                  break;
                }
            ...
            function $(e, t, n, r) {
              ...
              if (_) {
                e: {
                  for (s = 1, u = _[0]; u >= 10; u /= 10, s++);
                  if ((i = t - s) < 0)
                    (i += d),
                      (o = t),
                      (m = ((l = _[(h = 0)]) / g[s - o - 1]) % 10 | 0);
                  else if ((h = c((i + 1) / d)) >= _.length) {
                    if (!r) break e;
                    for (; _.length <= h; _.push(0));
                    (l = m = 0), (s = 1), (o = (i %= d) - d + 1);
                  } else {
                    for (l = u = _[h], s = 1; u >= 10; u /= 10, s++);
                    m =
                      (o = (i %= d) - d + s) < 0
                        ? 0
                        : (l / g[s - o - 1]) % 10 | 0;
                  ...
                  if (
                    (0 == i
                      ...
                      : ((_.length = h + 1),
                        (u = g[d - i]),
                        (_[h] = o > 0 ? a((l / g[s - o]) % g[o]) * u : 0)),
                    r)
                  )
                    for (;;) {
                      if (0 == h) {
                        for (i = 1, o = _[0]; o >= 10; o /= 10, i++);
                        for (o = _[0] += u, u = 1; o >= 10; o /= 10, u++);
                        i != u && (e.e++, _[0] == f && (_[0] = 1));
                        break;
                      }
                      if (((_[h] += u), _[h] != f)) break;
                      (_[h--] = 0), (u = 1);
                    }
            ...
            return (
                    ...
                    if (e.hasOwnProperty((t = 'CRYPTO'))) {
                      ...
                      if (n) {
                        if (
                          ...
                          throw ((G = !n), Error(u + 'crypto unavailable'));
                        G = n;
                      } else G = n;
                    }
                    if (
              ...
              (K.random =
                ...
                function (e) {
                  var t,
                    ...
                    l = [],
                    f = new K(R);
                  if ((null == e ? (e = x) : E(e, 0, _), (s = c(e / d)), G))
                    if (crypto.getRandomValues) {
                      ...
                      if (!crypto.randomBytes)
                        throw ((G = !1), Error(u + 'crypto unavailable'));
              ...
              (K.sum = function () {
                for (var e = 1, t = arguments, n = new K(t[0]); e < t.length; )
                  n = n.plus(t[e++]);
                return n;
              }),
              (r = (function () {
                ...
                return function (r, s, i, o, c) {
                  ...
                  for (
                    _ >= 0 &&
                      ...
                      (D = 0),
                      (r = r.replace('.', '')),
                      (h = (m = new K(s)).pow(r.length - _)),
                      (D = f),
                      (m.c = t(S(v(h.c), h.e, '0'), 10, i, e)),
                      (m.e = m.c.length)),
                      l = f =
                        (p = t(r, s, i, c ? ((a = H), e) : ((a = e), H)))
                          .length;
                    0 == p[--f];
                    p.pop()
                  );
                  ...
                  if (
                    ...
                    r = d ? S(a.charAt(1), -g, a.charAt(0)) : a.charAt(0);
                  else {
                    if (((p.length = u), d))
                      for (--i; ++p[--u] > i; )
                        (p[u] = 0), u || (++l, (p = [1].concat(p)));
                    for (f = p.length; !p[--f]; );
                    for (_ = 0, r = ''; _ <= f; r += a.charAt(p[_++]));
                    r = S(r, l, a.charAt(0));
                  }
                  return r;
                };
              ...
              (n = (function () {
                ...
                return function (r, s, i, o, c) {
                  ...
                  if ((R[h] > (I[h] || 0) && l--, k < 0)) E.push(1), (p = !0);
                  else {
                    for (
                      A = I.length,
                        N = R.length,
                    ...
                    do {
                      if (((m = 0), (u = t(R, y, N, T)) < 0)) {
                        ...
                        if (
                          ...
                          for (; t(R, y, N, T) < 1; )
                            m++, n(y, N < T ? C : R, T, c), (T = y.length);
                      } else 0 === u && (m++, (y = [0]));
                      (E[h++] = m),
                        y[0] ? (y[T++] = I[w] || 0) : ((y = [I[w]]), (T = 1));
                    } while ((w++ < A || null != y[0]) && k--);
                    (p = null != y[0]), E[0] || E.splice(0, 1);
                  }
                  if (c == f) {
                    for (h = 1, k = E[0]; k >= 10; k /= 10, h++);
                    $(b, i + (b.e = h + l * d - 1) + 1, o, p);
                  } else (b.e = l), (b.r = +p);
                  return b;
                };
              })()),
              ...
              (I.decimalPlaces = I.dp =
                function (e, t) {
                  ...
                  if (
                    ((r = ((s = n.length - 1) - g(this.e / d)) * d), (s = n[s]))
                  )
                    for (; s % 10 == 0; s /= 10, r--);
                  return r < 0 && (r = 0), r;
                }),
              (I.dividedBy = I.div =
                function (e, t) {
                  return n(this, new K(e, t), x, L);
                }),
              (I.dividedToIntegerBy = I.idiv =
                function (e, t) {
                  return n(this, new K(e, t), 0, 1);
                }),
              (I.exponentiatedBy = I.pow =
                function (e, t) {
                  ...
                  if (
                    ...
                    return (
                      (h = new K(Math.pow(+X(p), o ? 2 - y(e) : +X(e)))),
                      t ? h.mod(t) : h
                    );
                  if (((l = e.s < 0), t)) {
                  ...
                  return r
                    ? h
                    : (l && (h = R.div(h)),
                      t ? h.mod(t) : i ? $(h, D, L, undefined) : h);
                }),
              (I.integerValue = function (e) {
                var t = new K(this);
                return null == e ? (e = L) : E(e, 0, 8), $(t, t.e + 1, e);
              }),
              (I.isEqualTo = I.eq =
                function (e, t) {
              ...
              (I.minus = function (e, t) {
                var n,
                  ...
                  o = this,
                  c = o.s;
                if (((t = (e = new K(e, t)).s), !c || !t)) return new K(NaN);
                ...
                var a = o.e / d,
                  ...
                  h = e.c;
                if (!a || !u) {
                  if (!l || !h) return l ? ((e.s = -t), e) : new K(h ? o : NaN);
                  if (!l[0] || !h[0])
                    return h[0]
                      ? ((e.s = -t), e)
                      : new K(l[0] ? o : 3 == L ? -0 : 0);
                }
                if (((a = g(a)), (u = g(u)), (l = l.slice()), (c = a - u))) {
                  for (
                    ...
                    !i.c || !e.s || (e.c && !e.c[0])
                      ...
                      : (9 == M
                          ? ((s = e.s),
                            ...
                            (r.s *= s))
                          : (r = n(i, e, 0, M)),
                        (e = i.minus(r.times(e))).c[0] || 1 != M || (e.s = i.s),
                        e)
                  );
                }),
              ...
              (I.plus = function (e, t) {
                ...
                var i = r.e / d,
                  ...
                  a = e.c;
                if (!i || !o) {
                  if (!c || !a) return new K(s / 0);
                  if (!c[0] || !a[0]) return a[0] ? e : new K(c[0] ? r : 0 * s);
                }
                if (((i = g(i)), (o = g(o)), (c = c.slice()), (s = i - o))) {
                  for (
                    s > 0 ? ((o = i), (n = a)) : ((s = -s), (n = c)),
                      n.reverse();
                    s--;
                  ...
                  if (
                    ...
                    for ((a = (u = r.e) + l) < 3 && (a = 0); ; )
                      if (
                        ...
                        v(i.c).slice(0, a) === (t = v(r.c)).slice(0, a))
                      ) {
                        if (
                          (r.e < u && --a,
              ...
              (I.toExponential = function (e, t) {
                return null != e && (E(e, 0, _), e++), V(this, e, t, 1);
              }),
              (I.toFixed = function (e, t) {
                return (
                  null != e && (E(e, 0, _), (e = e + this.e + 1)), V(this, e, t)
                );
              }),
                ...
                return (
                  ...
                  (m =
                    n(f, s, (o *= 2), L)
                      .minus(g)
                      .abs()
                      .comparedTo(n(l, r, o, L).minus(g).abs()) < 1
                      ? [f, s]
                      : [l, r]),
                  (B = c),
                  m
              ...
              (I.toPrecision = function (e, t) {
                return null != e && E(e, 1, _), V(this, e, t, 2);
              }),
              (I.toString = function (e) {
                ...
                return (
                  null === i
                    ...
                    : (null == e
                        ? (t =
                            i <= j || i >= U ? T(v(n.c), i) : S(v(n.c), i, '0'))
                        : 10 === e && z
                        ? (t = S(
                            v((n = $(new K(n), x + i + 1, L)).c),
                            n.e,
                            '0'
                          ))
                        : (E(e, 2, H.length, 'Base'),
                          (t = r(S(v(n.c), i, '0'), 10, e, s, !0))),
                      s < 0 && n.c[0] && (t = '-' + t)),
                  t
                );
              }),
         ...
         */ e.exports = (function () {
          ...
          function S() {
            try {
              ...
              return (o = e.runOnLoop || e.runOnContext), g();
            } catch (e) {
              return E();
            }
          }
          ...
          function F(e, t) {
            e._state === k && ((e._state = R), (e._result = t), a(M, e));
          }
          function H(e, t, n, r) {
              ...
              (e.prototype._eachEntry = function (e, t) {
                ...
                if (r === O) {
                  ...
                  if (s === A && e._state !== k)
                    ...
                    var c = new n(C);
                    o ? F(c, i) : B(c, e, s), this._willSettleAt(c, t);
                  } else
                    this._willSettleAt(
                      new n(function (t) {
                        return t(e);
        ...
        n({
          ...
          payload: {
            ...
            payload: {
              ...
              tx: o
                ? (0, i.transformTransaction)(o.descriptor, o.addresses, r)
                : (0, i.transformTransaction)(s, void 0, r),
            },
          },
        });
      },
          ...
          n.on('block', (n) =>
            (({ post: e }, n) => {
              e({
                ...
                payload: {
                  type: 'block',
                  payload: { blockHeight: n.height || 0, blockHash: n.hash },
                },
              });
            })(e, n)
          ),
      ...
      u = async (n) => {
        ...
        if ('accounts' === r.type)
          ...
          s = await (async ({ state: e, connect: t }, n) => {
            ...
            return s.length < 1
              ? (r.removeListener('notification', o),
                e.removeSubscription('notification'),
                r.unsubscribeAddresses())
              : r.subscribeAddresses(s);
          })(n, r.addresses);
      ...
      l = (n) => {
        switch (n.type) {
          case t.MESSAGES.GET_INFO:
            return (async (e) => {
              ...
              return {
                ...
                payload: Object.assign({ url: n.options.url }, r),
              };
            })(n);
          ...
          case t.MESSAGES.GET_ACCOUNT_BALANCE_HISTORY:
            return (async (e) => {
              const n = await e.connect(),
                r = await n.getAccountBalanceHistory(e.payload);
              return {
          ...
          case t.MESSAGES.GET_ACCOUNT_INFO:
            return (async (e) => {
              const n = await e.connect(),
                r = await n.getAccountInfo(e.payload);
              return {
                type: t.RESPONSES.GET_ACCOUNT_INFO,
                payload: (0, i.transformAccountInfo)(r),
              };
            })(n);
          case t.MESSAGES.GET_ACCOUNT_UTXO:
            return (async (e) => {
              const n = await e.connect(),
                r = await n.getAccountUtxo(e.payload);
              return {
                type: t.RESPONSES.GET_ACCOUNT_UTXO,
                payload: (0, i.transformUtxos)(r),
              };
            })(n);
          ...
          case t.MESSAGES.ESTIMATE_FEE:
            return (async (e) => {
              const n = await e.connect(),
                ...
                s = [];
              return (
                s.push({ feePerUnit: r.lovelacePerByte.toString() }),
                { type: t.RESPONSES.ESTIMATE_FEE, payload: s }
              );
            })(n);
          case t.MESSAGES.PUSH_TRANSACTION:
            return (async (e) => {
              ...
              return { type: t.RESPONSES.PUSH_TRANSACTION, payload: r };
            })(n);
